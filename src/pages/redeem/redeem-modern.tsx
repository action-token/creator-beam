    ...
    return (
        <div className="relative min-h-screen">
            ...
            <div className="mx-auto max-w-3xl px-5 pb-16">
                {/* Tabs */}
                <div className="relative mx-auto my-6 w-fit overflow-hidden rounded-[0.9rem] border border-black/15 p-[0.3rem] shadow-[0_8px_24px_rgba(0,0,0,0.05)]">
                    <Glass
                        className={{
                    ...
                    <div className="relative z-10 inline-flex items-center gap-0.5">
                        {(["redeem", "history"] as const).map((t) => (
                            ...
                            >
                                {t === "redeem" ? <Ticket className="h-4 w-4" /> : <Users className="h-4 w-4" />}
...
export default RedeemPageModern;