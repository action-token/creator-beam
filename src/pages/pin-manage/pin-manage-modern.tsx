        ...
        <div className="grid grid-cols-2 gap-2.5 sm:grid-cols-4">
            {items.map(({ key, label, icon: Icon }) => (
                <button
                    ...
                    className={cn(
                        "relative overflow-hidden rounded-[0.9rem] border border-black/15 p-3 text-left shadow-[0_8px_24px_rgba(0,0,0,0.05)] transition-all duration-200",
...
export default function PinManagePageModern() {
    ...
    return (
        <div className="relative min-h-screen pb-16">
            ...
            <div className="relative">
                <Glass
                    className={{
                        root: "pointer-events-none fixed inset-0 z-0",
                        tint: "bg-[#f3f1ea]/65",
                        effect:
            ...
            <div className="relative z-10 w-full p-6 space-y-6 overflow-y-auto">
            {/* Header */}
            <div className="mb-5 flex flex-wrap items-center justify-between gap-3">
                ...
                {/* Tabs */}
                <div className="relative w-fit overflow-hidden rounded-[0.9rem] border border-black/15 p-[0.3rem] shadow-[0_8px_24px_rgba(0,0,0,0.05)]">
                    <Glass
                        className={{
