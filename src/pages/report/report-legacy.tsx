...
function CreatorCollectionReportLegacy() {
...
export default CreatorCollectionReportLegacy;
...
export function ReportDownloadItem({
  day,
  children,
  creatorId,
}: {
...
export function DownloadPinLocationAsCSV(
