...
function useCircle(props: CircleProps) {
  ...
  useEffect(() => {
    ...
    // Fix: Define event mappings as a tuple array with definite types
    const eventMappings: Array<[string, keyof typeof callbacks.current]> = [
      ['click', 'onClick'],
      ['drag', 'onDrag'],
    ...
    eventMappings.forEach(([eventName, eventCallback]) => {
